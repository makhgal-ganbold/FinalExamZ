...
\SetBgContents{\textcolor{black}{FinalExamZ\ \copyright\ 2015-2016\ Галаа\ (www.galaa.mn).\ \LaTeX\ ашиглав.}}
...
\pagestyle{fancy}
\lhead{Оюутны овог ба нэр: $\ldots\ldots\ldots\ldots\ldots\ldots\ldots$} \chead{} \rhead{Оюутны ID: $\ldots\ldots\ldots\ldots\ldots\ldots\ldots$} 
...
\begin{center}
\Large\textit{ \examtype\,\,--\,\,\examdate \\ хувилбар: \arabic{variant} }
\end{center}
\vspace{1.5cm}
...
\newcommand{\problem}[4][1.5]{
 ...
 #2 
 \vspace{2mm} \par \textit{Бодолт}: \par \vspace{-2em} \ %
...
\newcommand{\question}[4][0.5]{
 ...
 #2 
 \vspace{2mm} \par \textit{Хариулт}: \par \vspace{-2em} \ %
 \ifthenelse{\equal{\printsolution}{yes}}{#4}{\vspace*{#1cm}}
 \vspace{-1em}$$\,$$\textcolor{black!50}{\hrulefill}
}
...
\newcommand{\stest}[3]{
 ...
 #1 
 \vspace{2mm} \par \textit{\ifthenelse{\equal{\printsolution}{yes}}{Зөв сонголт}{Сонголт}}: \setcounter{testchoices}{1}
 \begin{center}
  \splitlist{#3}
 \end{center}
